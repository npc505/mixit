        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 p-24'>
            <div>
                {phrases.map((text, index) => (
                        <motion.p
                        key={index}
                        className="text-7xl text-gray-200 font-bold font-poppins"
                    ...
                    <p className='text-7xl text-gray-900 font-bold font-poppins'>Mix It</p>
                    <p className='text-4xl text-gray-900 font-bold font-poppins pt-6'>Unleash your best fashion combinations</p>
